...
def power_conso():
    ...
    plt.savefig("/home/brain/Documents/Test/audioset_tagging_cnn/results/Jetson_Power_Consumption.png")
    
    with open("/home/brain/Documents/Test/audioset_tagging_cnn/results/Power_Consumption_bis.csv", 'w', newline='') as f:
    	writer = csv.writer(f)
