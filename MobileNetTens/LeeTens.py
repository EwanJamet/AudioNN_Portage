...
def Convert_ONNX():
    ...
    res_width = 224000
    path_model = "../audioset_tagging_cnn/MobileNetTens/Weight_NN/LeeTens_10_test_input.onnx"
    x = torch.randn(res_height, res_width, device="cpu")
    print("input : ",x.shape)
    torch.onnx.export(
...
path = "../audioset_tagging_cnn/LeeNet11.pth"
...
print(len(list(checkpoint['model'].keys())))
